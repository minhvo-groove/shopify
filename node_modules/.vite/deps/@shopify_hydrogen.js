...
import {
  ...
  useNavigate,
  useNavigation
} from "./chunk-L7NO2QRM.js";
import "./chunk-3DJOPCK5.js";
import {
  require_react
...
function requireUseSyncExternalStoreShim_development() {
  ...
  if (true) {
    (function() {
      ...
      var useState10 = React3.useState, useEffect11 = React3.useEffect, useLayoutEffect2 = React3.useLayoutEffect, useDebugValue = React3.useDebugValue;
...
function requireWithSelector_development() {
  ...
  if (true) {
    (function() {
      ...
      var useRef5 = React3.useRef, useEffect11 = React3.useEffect, useMemo10 = React3.useMemo, useDebugValue = React3.useDebugValue;
...
function Text({
  ...
  if (node.bold)
    return (0, import_jsx_runtime19.jsx)("strong", { children: node.value });
  if (node.italic)
    return (0, import_jsx_runtime19.jsx)("em", { children: node.value });
  return node.value;
}
...
// node_modules/content-security-policy-builder/dist/index.mjs
var dist_default = ({ directives }) => {
...
var checkGraphQLErrors = (body, response) => !(body == null ? void 0 : body.errors) && response.status < 400;
...
var SeoLogger = (0, import_react27.lazy)(() => import("./log-seo-tags-IG37ONQ2-S4YKNSUS.js"));
function Seo({ debug }) {
  ...
  const seoConfig = (0, import_react27.useMemo)(() => {
  ...
  const { html, loggerMarkup } = (0, import_react27.useMemo)(() => {
    const headTags = generateSeoTags(seoConfig);
    const html2 = headTags.map((tag) => {
      if (tag.tag === "script") {
        return (0, import_react27.createElement)(tag.tag, {
          ...tag.props,
          key: tag.key,
          dangerouslySetInnerHTML: { __html: tag.children }
        });
      }
      return (0, import_react27.createElement)(tag.tag, { ...tag.props, key: tag.key }, tag.children);
    });
    const loggerMarkup2 = (0, import_react27.createElement)(
      import_react27.Suspense,
      { fallback: null },
      (0, import_react27.createElement)(SeoLogger, { headTags })
    );
    return { html: html2, loggerMarkup: loggerMarkup2 };
  }, [seoConfig]);
  return (0, import_react27.createElement)(import_react27.Fragment, null, html, debug && loggerMarkup);
}
...
function Pagination({
  ...
  const state = (0, import_react27.useMemo)(
    () => ({
      pageInfo: {
        endCursor,
        hasPreviousPage,
  ...
  const NextLink = (0, import_react27.useMemo)(
    () => (0, import_react27.forwardRef)(function NextLink2(props, ref) {
      return hasNextPage ? (0, import_react27.createElement)(Link, {
  ...
  const PreviousLink = (0, import_react27.useMemo)(
    () => (0, import_react27.forwardRef)(function PrevLink(props, ref) {
      return hasPreviousPage ? (0, import_react27.createElement)(Link, {
        preventScrollReset: true,
        ...props,
        to: previousPageUrl,
        state,
...
function usePagination(connection) {
  ...
  const nodes = (0, import_react27.useMemo)(() => {
    var _a3;
    if (!((_a3 = globalThis == null ? void 0 : globalThis.window) == null ? void 0 : _a3.__hydrogenHydrated) || !state || !(state == null ? void 0 : state.nodes)) {
  ...
  const currentPageInfo = (0, import_react27.useMemo)(() => {
    var _a3, _b, _c, _d, _e;
    const hydrogenHydrated = (_a3 = globalThis == null ? void 0 : globalThis.window) == null ? void 0 : _a3.__hydrogenHydrated;
    let pageStartCursor = !hydrogenHydrated || ((_b = state == null ? void 0 : state.pageInfo) == null ? void 0 : _b.startCursor) === void 0 ? connection.pageInfo.startCursor : state.pageInfo.startCursor;
    let pageEndCursor = !hydrogenHydrated || ((_c = state == null ? void 0 : state.pageInfo) == null ? void 0 : _c.endCursor) === void 0 ? connection.pageInfo.endCursor : state.pageInfo.endCursor;
    let previousPageExists = !hydrogenHydrated || ((_d = state == null ? void 0 : state.pageInfo) == null ? void 0 : _d.hasPreviousPage) === void 0 ? connection.pageInfo.hasPreviousPage : state.pageInfo.hasPreviousPage;
    let nextPageExists = !hydrogenHydrated || ((_e = state == null ? void 0 : state.pageInfo) == null ? void 0 : _e.hasNextPage) === void 0 ? connection.pageInfo.hasNextPage : state.pageInfo.hasNextPage;
    if (state == null ? void 0 : state.nodes) {
      if (isPrevious) {
  ...
  const urlRef = (0, import_react27.useRef)({
  ...
  const previousPageUrl = (0, import_react27.useMemo)(() => {
  ...
  const nextPageUrl = (0, import_react27.useMemo)(() => {
    const params2 = new URLSearchParams(search);
...
function createCustomerAccountClient({
  ...
  async function exchangeForStorefrontCustomerAccessToken() {
    ...
    const customerAccessToken = (_a3 = data == null ? void 0 : data.storefrontCustomerAccessTokenCreate) == null ? void 0 : _a3.customerAccessToken;
  ...
  return {
    login: async (options) => {
      ...
      if (options == null ? void 0 : options.uiLocales) {
...
function createCartHandler(options) {
  ...
  const methods = {
    ...
    addLines: async (linesWithOptimisticData, optionalParams) => {
      ...
      return cartId || (optionalParams == null ? void 0 : optionalParams.cartId) ? await cartLinesAddDefault(mutateOptions)(lines, optionalParams) : await cartCreate({ lines }, optionalParams);
    },
...
function VariantSelector({
  ...
  const optionsWithOnlyOneValue = options.filter(
    (option) => {
      var _a3;
      return ((_a3 = option == null ? void 0 : option.values) == null ? void 0 : _a3.length) === 1;
    }
  );
      ...
      return options.map((option) => {
        ...
        for (let value of option.values) {
          ...
          const variant = variants.find(
            (variant2) => {
              var _a3;
              return (_a3 = variant2 == null ? void 0 : variant2.selectedOptions) == null ? void 0 : _a3.every(
...
function useOptimisticVariant(selectedVariant, variants) {
  const navigation = useNavigation();
  const [resolvedVariants, setResolvedVariants] = (0, import_react27.useState)([]);
  (0, import_react27.useEffect)(() => {
...
var NonceContext = (0, import_react27.createContext)(void 0);
var NonceProvider = NonceContext.Provider;
var useNonce = () => (0, import_react27.useContext)(NonceContext);
function createContentSecurityPolicy(props) {
  const nonce = generateNonce();
  const header = createCSPHeader(nonce, props);
  const Provider = ({ children }) => {
    return (0, import_react27.createElement)(NonceProvider, { value: nonce }, children);
  };
  return {
    nonce,
    header,
...
var Script = (0, import_react27.forwardRef)(
  (props, ref) => {
...
function useCustomerPrivacy(props) {
  ...
  const loadedEvent = (0, import_react27.useRef)(false);
  ...
  (0, import_react27.useEffect)(() => {
    ...
    if (withPrivacyBanner && (window == null ? void 0 : window.privacyBanner)) {
      (_a3 = window.privacyBanner) == null ? void 0 : _a3.loadBanner(config);
    }
    if (!((_b = window.Shopify) == null ? void 0 : _b.customerPrivacy)) return;
...
function ShopifyAnalytics({
  ...
  const [shopifyReady, setShopifyReady] = (0, import_react27.useState)(false);
  const [privacyReady, setPrivacyReady] = (0, import_react27.useState)(false);
  const init = (0, import_react27.useRef)(false);
...
function CartAnalytics({
  ...
  const lastEventId = (0, import_react27.useRef)(null);
  (0, import_react27.useEffect)(() => {
...
var AnalyticsContext = (0, import_react27.createContext)(
...
function AnalyticsProvider({
  ...
  var _a3;
  const listenerSet = (0, import_react27.useRef)(false);
  const { shop } = useShopAnalytics(shopProp);
  const [consentLoaded, setConsentLoaded] = (0, import_react27.useState)(
    customCanTrack ? true : false
  );
  const [carts, setCarts] = (0, import_react27.useState)({ cart: null, prevCart: null });
  const [canTrack, setCanTrack] = (0, import_react27.useState)(
...
function useAnalytics() {
  const analyticsContext = (0, import_react27.useContext)(AnalyticsContext);
  if (!analyticsContext) {
    throw new Error(
...
function useShopAnalytics(shopProp) {
  const [shop, setShop] = (0, import_react27.useState)(null);
  (0, import_react27.useEffect)(() => {
...
function createHydrogenContext(options) {
  ...
  const customerAccount = createCustomerAccountClient({
    ...
    unstableB2b: customerAccountOptions == null ? void 0 : customerAccountOptions.unstableB2b,
    // defaults
